        ...
        <div class="modal-content modal-premium">
            <div class="modal-header">
                <div style="display: flex; align-items: center; gap: 16px;">
                    ...
                    <div>
                        <h5 class="modal-title" id="addRelativeModalLabel" style="font-weight: 700; margin: 0;">{{ __('Thêm người phụ thuộc mới') }}</h5>
                        <p style="margin: 0; font-size: 13px; opacity: 0.8;">{{ __('Điền thông tin người thân của nhân viên') }}</p>
                    </div>
                </div>
            ...
            <form id="addRelativeForm">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-6">
                            <label class="form-label" style="font-weight: 600;">{{ __('Họ và tên') }} <span
                                    class="text-danger">*</span></label>
                            <div class="form-icon-group">
                                <i class="bi bi-person-fill form-icon"></i>
                                <input type="text" name="HoTen" class="form-control form-icon-input"
                                    placeholder="{{ __('Họ và tên') }}" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <label class="form-label" style="font-weight: 600;">{{ __('Quan hệ') }} <span
                                    class="text-danger">*</span></label>
                            <div class="form-icon-group">
                                <i class="bi bi-diagram-3-fill form-icon"></i>
                                <select name="QuanHe" class="form-select" data-placeholder="{{ __('Chọn quan hệ') }}" required>
                                    <option value=""></option>
                                    <option value="bo_de">{{ __('Bố đẻ') }}</option>
                                    <option value="me_de">{{ __('Mẹ đẻ') }}</option>
                                    <option value="vo_chong">{{ __('Vợ/Chồng') }}</option>
                                    <option value="con_ruot">{{ __('Con ruột') }}</option>
                                    <option value="con_nuoi">{{ __('Con nuôi') }}</option>
                                    <option value="khac">{{ __('Khác') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-4">
                            <label class="form-label" style="font-weight: 600;">{{ __('Ngày sinh') }}</label>
                            <div class="form-icon-group">
                        ...
                        <div class="col-4">
                            <label class="form-label" style="font-weight: 600;">{{ __('CCCD/CMND') }}</label>
                            <div class="form-icon-group">
                                <i class="bi bi-card-heading form-icon"></i>
                                <input type="text" name="CCCD" class="form-control form-icon-input"
                                    placeholder="{{ __('Số CCCD') }}">
                            </div>
                        </div>
                        <div class="col-4">
                            <label class="form-label" style="font-weight: 600;">{{ __('Điện thoại') }}</label>
                            <div class="form-icon-group">
                        ...
                        <div class="col-5">
                            <label class="form-label" style="font-weight: 600;">{{ __('Mã số thuế') }}</label>
                            <div class="form-icon-group">
                        ...
                        <div class="col-7">
                            <label class="form-label" style="font-weight: 600;">{{ __('Giấy tờ chứng minh (Ảnh/PDF)') }}</label>
                        ...
                        <div class="col-12">
                            <label class="toggle-switch-group" for="laGiamTru"
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div>
                                        <div style="font-weight: 600;" class="toggle-title">{{ __('Người phụ thuộc') }}</div>
                                        <div style="font-size: 13px;" class="toggle-subtitle">{{ __('Giảm trừ gia cảnh (thuế TNCN)') }}
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer" style="padding: 24px;">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        style="border-radius: 8px; padding: 10px 24px;">{{ __('Hủy bỏ') }}</button>
