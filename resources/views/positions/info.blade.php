...
@section('title', 'Thông tin chức vụ - ' . \App\Models\SystemConfig::getValue('company_name'))
...
@section('content')
    ...
    <div class="card" style="margin-top: 24px;">
        <div class="card-header-flex">
            <h3 class="card-title">Danh sách nhân viên giữ chức vụ này</h3>
        ...
        $(document).ready(function() {
            const empTable = $('#employeeTable').DataTable({
                ...
                columnDefs: [
                    ...
                    { targets: 3, responsivePriority: 4 }, // Phòng ban
